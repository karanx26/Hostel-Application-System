...
var usePDF = function usePDF(_ref) {
  ...
  var pdfInstance = require$$1.useRef(null);
  var _useState = require$$1.useState({
      url: null,
      blob: null,
      error: null,
      loading: false
...
var PDFViewer = function PDFViewer(_ref) {
  ...
  require$$1.useEffect(updateInstance, [children]);
  var src = instance.url ? instance.url + "#toolbar=" + (showToolbar ? 1 : 0) : null;
  return /*#__PURE__*/jsxRuntime.jsx("iframe", _extends__default["default"]({
    src: src,
    title: title,
    ref: innerRef,
    style: style,
...
var BlobProvider = function BlobProvider(_ref) {
  ...
  var _usePDF = usePDF({
    ...
    instance = _usePDF[0],
    updateInstance = _usePDF[1];
  require$$1.useEffect(updateInstance, [doc]);
  if (!doc) {
